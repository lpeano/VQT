...
1. **Collasso GERARCHICO**: la migrazione/aggregazione e' VERIFICATA intra-anello (3.7b);
   resta da estendere l'advezione ai livelli L2+ (aggregazione TRA blocchi, strutture
   su scale maggiori).
